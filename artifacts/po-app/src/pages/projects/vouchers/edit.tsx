            ...
            <div className="space-y-3">
              ...
              {items.map((it, i) => (
                <div key={i} className="grid grid-cols-12 gap-2 items-center">
                  ...
                  <div className="col-span-2">
                    <Input type="text" inputMode="decimal" min="0" step="0.01" value={it.amount} onChange={e => setItem(i, "amount", e.target.value)} className="[appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none" />
                  </div>
