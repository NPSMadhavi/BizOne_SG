...
import { Building2, Users2, Search, CheckCircle2, MapPin, Plus } from "lucide-react";
...
export function DirectoryPickerButton({ type, onSelect, label }: DirectoryPickerButtonProps) {
  ...
  function handleClose(v: boolean) {
    if (!v) { setOpen(false); setSearch(""); }
    else setOpen(true);
  }

  // Called when a new vendor/customer is successfully created via the full dialog
