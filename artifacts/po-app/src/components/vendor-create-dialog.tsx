...
export function VendorCreateDialog({ open, onOpenChange, onSuccess, initialName = "" }: Props) {
      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="space-y-1.5">
            ...
            <Input value={form.postalCode} onChange={e => setField("postalCode", e.target.value)} placeholder="e.g. 408564 (SG) or 530007 (IN)" className="max-w-[200px]" />
            ...
            <div className="border rounded-lg p-4 bg-blue-50 border-blue-200 flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-blue-700 mt-1">
                  This vendor is based in <strong>{form.country}</strong>, outside your company's country ({companyCountry}).
                  Imports from overseas suppliers are treated as <strong>zero-rated (0%)</strong>.
                </p>
              </div>
            </div>
          ) : (
            <div className="border rounded-lg p-4 space-y-3 bg-muted/30">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">Toggle on if this vendor charges {taxLabel} ({companyGstRate}%)</p>
                </div>
