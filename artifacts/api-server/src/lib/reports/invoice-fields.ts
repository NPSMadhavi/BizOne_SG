...
export const INVOICE_REPORT_FIELDS = [
  ...
  { fieldKey: "invoice.customer_note", fieldLabel: "Customer Note", fieldGroup: "Invoice", dataType: "string", isRepeatable: false },
  { fieldKey: "invoice.delivery_instructions", fieldLabel: "Delivery Instructions", fieldGroup: "Invoice", dataType: "string", isRepeatable: false },
  { fieldKey: "invoice.terms_and_conditions", fieldLabel: "Terms & Conditions", fieldGroup: "Invoice", dataType: "string", isRepeatable: false },
  { fieldKey: "invoice.authorised_signature", fieldLabel: "Authorised Signature", fieldGroup: "Invoice", dataType: "image", isRepeatable: false },
